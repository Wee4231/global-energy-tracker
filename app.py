...
CHOKEPOINTS = {
    "Strait of Hormuz": {
        ...
        "affected_countries": [
            ...
            {"country": "🇲🇾 Malaysia",         "score": 42, "reason": "~60% crude imports from Middle East; Petronas RAPID refinery (Johor) relies on Gulf feedstock"},
            {"country": "🇹🇭 Thailand",         "score": 40, "reason": "~70% crude from Middle East; Map Ta Phut industrial estate + Bangkok power grid fuel imports blocked"},
            {"country": "🇵🇭 Philippines",      "score": 38, "reason": "~85% oil imports from Middle East; no strategic reserve; Luzon grid collapses within days"},
            {"country": "🇻🇳 Vietnam",          "score": 35, "reason": "~60% crude from Gulf; Nghi Son + Binh Son refineries calibrated for Middle East crude grades"},
            {"country": "🇮🇩 Indonesia",        "score": 30, "reason": "Net oil importer since 2004; ~50% crude from Middle East; domestic Pertamina refineries exposed"},
            {"country": "🇱🇰 Sri Lanka",        "score": 35, "reason": "100% oil imported; virtually all from Middle East; 2022 crisis showed zero buffer; repeat collapse risk"},
        ],
    },
    "Strait of Malacca": {
        "lat": 2.5, "lon": 101.5,
